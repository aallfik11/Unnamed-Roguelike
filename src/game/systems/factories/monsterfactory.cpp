...
MonsterFactory::MonsterBuilder::MonsterBuilder(Entity *const monster)
{
    is_humanoid_   = false;
...
MonsterFactory::MonsterBuilder::start(Entity *const monster)
{
    this->monster_     = monster;
...
MonsterFactory::MonsterBuilder &MonsterFactory::MonsterBuilder::humanoid()
{
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::name(const std::string &name)
{
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::ai(const AIType &ai_type)
{
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::los(const uint16_t seeing_distance)
{
    monster_->getComponent<LOSComponent>()->seeing_distance = seeing_distance;
    return *this;
}

MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::health(const uint16_t max_hp)
{
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::baseDamage(const uint16_t damage)
{
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::baseArmor(const uint8_t armor_class)
{
    monster_->getComponent<ArmorComponent>()->armor_class = armor_class;
    return *this;
}

MonsterFactory::MonsterBuilder &MonsterFactory::MonsterBuilder::critComponent(
    const uint8_t                            crit_chance,
...
MonsterFactory::MonsterBuilder &MonsterFactory::MonsterBuilder::buffComponent(
    std::initializer_list<EffectComponent *> buffs)
{
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::coordinates(const uint16_t x, const uint16_t y)
{
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::tileComponent(const TileAppearance sprite)
{
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::experience(const uint8_t  level,
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::inventory(std::initializer_list<Entity *> items)
{
    if (is_humanoid_ == false && monster_->hasComponent<Inventory>() == false)
    {
        monster_->addComponent(new Inventory);
    }
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::weapon(Entity *const weapon)
{
    ...
    if (auto buff = weapon->getComponent<BuffComponent>())
    {
        System::sendSystemMessage(
            SystemType::EFFECT,
            {std::make_any<SystemAction::EFFECT>(SystemAction::EFFECT::ADD),
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::armor(Entity *const armor)
{
    if (is_humanoid_ == false)
    {
        monster_->addComponent(new ArmorSlot);
...
MonsterFactory::MonsterBuilder &
MonsterFactory::MonsterBuilder::rings(uint8_t                         max_rings,
...
bool MonsterFactory::rollChance(int chance)
{
    if (chance <= 0)
        return false;
    if (chance >= 100)
...
int MonsterFactory::rollRandomFromRange(int min_value, int max_value)
{
...
void MonsterFactory::addRandomArmor(Entity *const monster,
                                    uint8_t       armor_chance,
                                    uint8_t       rarity_modifier)
{
...
void MonsterFactory::addRandomWeapon(Entity *const monster,
...
void MonsterFactory::addRandomRing(Entity *const monster,
                                   uint8_t       ring_chance,
                                   uint8_t       max_rings,
                                   uint8_t       rarity_modifier)
{
    ...
    {
        MonsterBuilder builder(monster);
        builder.rings(max_rings, {item_factory_.generateRing(rarity_modifier)});
    }
}

void MonsterFactory::addRandomPotion(Entity *const monster,
...
void MonsterFactory::addRandomFoodRation(Entity *const monster,
                                         uint8_t       food_chance,
                                         uint8_t       rarity_modifier)
{
    ...
    {
        MonsterBuilder builder(monster);
        builder.inventory({item_factory_.generateFoodRation(rarity_modifier)});
    }
}

Entity *MonsterFactory::generateBaseMonster()
{
...
void MonsterFactory::generateRat(Entity *const monster)
{
...
void MonsterFactory::generateBat(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.name("Bat")
...
void MonsterFactory::generateGiantSpider(Entity *const monster)
{
    MonsterBuilder builder(monster);
...
void MonsterFactory::generateViper(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.name("Viper")
        .ai(AIType::AI_MONSTER_AGGRESSIVE)
        ...
        .baseDamage(1)
        .baseArmor(25)
        .critComponent(25, 1.0l, {new EffectComponent(Effect::POISON, 1, 4)})
        .tileComponent(TileAppearance::VIPER)
        .experience(1, 40);
}
void MonsterFactory::generateKobold(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.humanoid()
        .name("Kobold")
...
void MonsterFactory::generateGoblin(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.humanoid()
        .name("Goblin")
...
void MonsterFactory::generateOrc(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.humanoid()
        .name("Orc")
...
void MonsterFactory::generateTroll(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.humanoid()
        .name("Troll")
...
void MonsterFactory::generateZombie(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.humanoid()
        .name("Zombie")
        ...
        .baseDamage(2)
        .baseArmor(15)
        .critComponent(33, 1.5, {new EffectComponent(Effect::POISON, 1, 10)})
...
void MonsterFactory::generateDeathknight(Entity *const monster)
{
    ItemBuilder sword;
    ItemBuilder armor;
...
void MonsterFactory::generateAssassin(Entity *const monster)
{
...
void MonsterFactory::generateDemon(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.name("Demon")
        .ai(AIType::AI_MONSTER_AGGRESSIVE)
...
void MonsterFactory::generateVampire(Entity *const monster)
{
...
void MonsterFactory::generateDragon(Entity *const monster)
{
    MonsterBuilder builder(monster);
    builder.name("Dragon")
        .ai(AIType::AI_MONSTER_AGGRESSIVE)
...
void MonsterFactory::generateGiantVenusFlytrap(Entity *const monster)
{
    MonsterBuilder builder(monster);
...
void MonsterFactory::placeMonster(Entity *const monster)
{
...
MonsterFactory::MonsterFactory(ItemFactory &item_factory, int &depth)
    : item_factory_{item_factory}, current_depth_{depth}
{
    ...
    monster_generators_[GIANT_SPIDER] = &MonsterFactory::generateGiantSpider;
    ...
    low_level_monster_amount_distro_  = std::uniform_int_distribution<>(0, 0);
    med_level_monster_amount_distro_  = std::uniform_int_distribution<>(0, 0);
    high_level_monster_amount_distro_ = std::uniform_int_distribution<>(0, 0);
...
std::list<Entity *> MonsterFactory::generateMonsters() noexcept(false)
{
    if (map_ == nullptr)
        throw std::runtime_error("Monster Factory: ERROR -> Map unassigned");
    ...
    int low_level_monster_amount = low_level_monster_amount_distro_(mt_engine_);
    int med_level_monster_amount = med_level_monster_amount_distro_(mt_engine_);
...
void MonsterFactory::assignMap(observer_ptr<std::vector<std::vector<Tile>>> map)
{
    this->map_ = map;
}
