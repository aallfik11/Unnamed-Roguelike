...
void EffectSystem::addEntity(const observer_ptr<Entity> entity)
{
    buffable_entities_.insert(entity);
}
void EffectSystem::addEntity(
    std::initializer_list<observer_ptr<Entity>> &entities)
{
...
void EffectSystem::removeEntity(const observer_ptr<Entity> entity)
{
    buffable_entities_.erase(entity);
}

void EffectSystem::applyEffect(const observer_ptr<Entity>          caller,
...
void EffectSystem::updateEffects()
{
...
void EffectSystem::updateEffects(const observer_ptr<Entity> entity)
{
...
void EffectSystem::addEffects(const observer_ptr<Entity>              entity,
...
void EffectSystem::cleanseEffects(
    const observer_ptr<Entity>              entity,
...
void EffectSystem::cleanseEffects(const observer_ptr<Entity> entity)
{
    if (auto entity_buffs = entity->getComponent<BuffComponent>())
    {
        if (buffable_entities_.contains(entity) == false)
...
void EffectSystem::readSystemMessages()
{
    for (auto &message : (*system_messages_)[SystemType::EFFECT])
    {
        auto message_iterator = message.begin();
        auto action = std::any_cast<SystemAction::EFFECT>(*message_iterator);
        auto entity =
...
void EffectSystem::clearSystemMessages()
{
...
void EffectSystem::resetSystem()
{
    clearSystemMessages();
    buffable_entities_.clear();
}

std::ostream &EffectSystem::serialize(std::ostream &os) const
{
...
std::istream &EffectSystem::deserialize(std::istream &is)
{
...
void EffectSystem::loadEntities(std::list<observer_ptr<Entity>> entities)
{
    for (auto &entity : entities)
    {
        addEntity(entity);
