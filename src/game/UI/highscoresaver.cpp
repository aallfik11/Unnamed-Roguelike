...
HighScoreSaver::HighScoreSaver(ftxui::ScreenInteractive &scr) : scr_{scr}
{
...
void HighScoreSaver::render(uint64_t score, bool win)
{
        ...
        [&]
        {
            ...
            return vbox(
                {end_message | center,
                 ...
                 separatorEmpty(),
                 window(text(message) | color(text_color), input->Render()) |
                     center | flex_grow,
                 controls});
        });
